...
#
# Time-stamp: <2026/07/17 08:51:50 (UT+08:00) daisuke>
#
...
def main ():
    # data file name
    file_data = 'galaxy_collision_3.data'

    # name of directory for storing PNG files
    dir_png = 'galaxy_collision_3'
    ...
    with open (file_data, 'r') as fh:
        ...
        for line in fh:
            ...
            # axes
            ax.set_xlim (-100000.0, +100000.0)
            ax.set_ylim (-100000.0, +100000.0)
            ax.set_aspect ('equal')
            ax.grid ()
            ...
            # title
            ax.set_title (f"galaxy collision")
