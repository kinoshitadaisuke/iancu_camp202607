...
#
# Time-stamp: <2026/07/16 22:26:45 (UT+08:00) daisuke>
#
...
def main ():
    # output file name
    file_sim = 'galaxy_collision_2.bin'
    ...
    gal1_offset_x = -15000.0
    gal1_offset_y = -10000.0
    gal1_offset_z = +0.0
    # position offset of galaxy 2
    gal2_offset_x = +15000.0
    gal2_offset_y = +10000.0
    gal2_offset_z = +0.0
